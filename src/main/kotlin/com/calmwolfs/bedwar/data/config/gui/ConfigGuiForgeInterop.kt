...
class ConfigGuiForgeInterop : IModGuiFactory {
    ...
    override fun mainConfigGuiClass() = WrappedBedWarConfig::class.java
    ...
    class WrappedBedWarConfig(private val parent: GuiScreen) : GuiScreenElementWrapper(ConfigGuiManager.editor) {
